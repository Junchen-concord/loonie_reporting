...
def main() -> None:
    ...
    parser.add_argument(
        ...
        type=str,
        default="7,30,60",
        help="Comma-separated rolling windows for serving snapshot (e.g. 7,30,60)",
    )
    parser.add_argument(
    ...
    raw_files = run_accept_count(date_range=args.date_range, time_range=args.time_range)
    LOGGER.info("Wrote %d raw Accept Count output files.", len(raw_files))
